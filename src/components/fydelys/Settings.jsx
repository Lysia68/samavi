...
function Settings({ isMobile, onImpersonate }) {
  ...
  // ── Tab: Studio settings ──────────────────────────────────────────────────
  // Composant aperçu site vitrine — défini hors TabStudio pour éviter les erreurs de hooks
  const VitrinPreview = ({ name, city, description, cover, accent, slug }) => {
